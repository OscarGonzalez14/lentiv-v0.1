        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="card-body" style="margin-top: 0px solid red;color: black !important">
              ...
              <a data-toggle="modal" data-target="#nuevo_usuario" onClick="get_codigo_usuario();" data-backdrop="static" data-keyboard="false" id="nuevo_usuario_lenti" class="btn btn-app nuevo_user" style="color: black;border: solid #0275d8 1px;"> 
